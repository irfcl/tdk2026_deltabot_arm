...
{
  /* USER CODE BEGIN 5 */
	extern void StartDefaultTask_rtos(void *argument);
	StartDefaultTask_rtos(argument);
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
...
//////
	extern void HAL_TIM_PeriodElapsedCallback_rtos(TIM_HandleTypeDef *htim);
	HAL_TIM_PeriodElapsedCallback_rtos(htim);
